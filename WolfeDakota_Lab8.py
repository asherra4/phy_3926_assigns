# Members: Dakota, Shane, Robbie, and Ashton
...
args7 = [1.0, 1.0] # Given in Part 2
ntime7 = int(0.03 // tau7) # Find number of time steps from max time and tau given in Figure 6.7      
nspace7 = 61 # Given in figure    
h7 = args7[0] / ( nspace7 - 1 )             
tau_rel7 = tau7 * ( 2 * args7[1] ) / (h7 ** 2) # Find tau_rel using Equation 6.28            
...
ax.set_ylabel('x')
ax.set_zlabel('T(x,t)')
ax.set_title('Figure 6.7: Diffusion of a delta spike')
...
plt.xlabel('Time')
plt.ylabel('x')
plt.title('Figure 6.7: Temperature contour plot')
plt.show()
